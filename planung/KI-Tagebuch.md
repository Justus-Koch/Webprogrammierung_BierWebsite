...
Erstelle mir das CSS und passe mein HTML und CSS so an, dass ich eine horizontale Navigationsleiste habe, die links die Suche, in der Mitte eine Überschrift und rechts einen Anmeldebutton enthält.
